(function() {
  ...
  this.HAMLjr.templates["code_following_text"] = function(data) {
    return (function() {
      var a, __attribute, __each, __element, __filter, __on, __pop, __push, __render, __text, __with, _ref;
